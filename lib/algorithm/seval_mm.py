...
class SEVALMixMatch(SEVAL):
    ...
    def __init__(self, cfg: CfgNode) -> None:
        ...
        self.mixup_alpha = cfg.ALGORITHM.MIXMATCH.MIXUP_ALPHA
    ...
    def run_step(self) -> NoReturn:
        ...
        with torch.no_grad():
            ...
            ul_pred1 = self.alpha * (ul_pred1 - self.pi.log())
            ul_pred2 = self.alpha * (ul_pred2 - self.pi.log())
